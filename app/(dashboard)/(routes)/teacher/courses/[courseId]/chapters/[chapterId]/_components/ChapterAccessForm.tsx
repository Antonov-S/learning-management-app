...
export const ChapterAccessForm = ({ initialData, courseId, chapterId }: ChapterAccessFormProps) => {
  ...
  return (
    <div className="mt-6 border bg-slate-100 rounded-md p-4">
      ...
      {!isEditing && <p className={cn("text-sm mt-2", !initialData.isFree && "text-slate-500 italic")}>{initialData.isFree ? <>This chapter is free for preview.</> : <>This chapter is not free.</>}</p>}
      {isEditing && (
        <Form {...form}>
